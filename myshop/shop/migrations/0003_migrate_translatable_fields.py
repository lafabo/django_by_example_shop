...
def forwart_func(apps, schema_editor):
    for model, fields in translatable_models.items():
        ...
        for obj in Model.objects.all():
            ...
            traslation = ModelTranslation.objects.create(master_id=obj.pk, language_code=settings.LANGUAGE_CODE, **translation_fields)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(forwart_func, backward_func),
    ]
